...
public partial class FileWindowTabViewModel : ViewModelBase {
    ...
    // Generated by CommunityToolkit when using [ObservableProperty]
    // This partial method is invoked automatically when CurrentFolderName changes.
    partial void OnCurrentFolderNameChanged(string value) {
        Logger.Debug($"CurrentFolderName changed to '{value}'");
    }
